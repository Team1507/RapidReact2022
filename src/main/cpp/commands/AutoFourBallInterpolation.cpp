...
AutoFourBallInterpolation::AutoFourBallInterpolation(Drivetrain *drivetrain,  Shooter *shooter, IntakeRear *rearintake, Feeder *feeder) 
{
  AddCommands
    (
        CmdPrintAutoText("Auto4Ball with Interpolation Start"),
        ...
        CmdTurretSetAngle(shooter, -20), // was -27
