...
AutoFourBall::AutoFourBall(Drivetrain *drivetrain, Intake *rearintake, Shooter *shooter, Feeder *feeder) 
{
    AddCommands
    (
		...
		CmdIntakeSetPower(rearintake, 0.6),
		CmdDriveRevGyroV2(drivetrain, 0.7, 0, 146.56, true, true, 0.0),
